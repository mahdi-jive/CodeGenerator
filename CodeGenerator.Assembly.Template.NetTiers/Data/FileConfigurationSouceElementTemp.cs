...
{
    public class FileConfigurationSouceElementTemp : CodeGeneratorBase<DataFactory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.FileConfigurationSouceElement);
        ...
        {
            string className = "FileConfigurationSouceElement";
