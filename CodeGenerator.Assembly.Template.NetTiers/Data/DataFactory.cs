...
namespace CodeGenerator.Assembly.Template.NetTiers.Data
{
    public class DataFactory : AssemblyGeneratorBase
    {
        private static readonly string LayerNamePosfix = "Data";
