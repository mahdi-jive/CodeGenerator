...
{
    public class FileConfigurationSouceTemp : CodeGeneratorBase<DataFactory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.FileConfigurationSouce);
        ...
        {
            string className = "FileConfigurationSouce";
