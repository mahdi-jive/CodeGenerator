...
{
    public class IEntityViewProviderTemp : CodeGeneratorBase<DataFactory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.IEntityViewProvider);
        ...
        {
            string className = "IEntityViewProvider";
