...
{
    internal class StringTokenizerTemp : CodeGeneratorBase<QueryDirectory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.StringTokenizer);
