...
namespace CodeGenerator.Assembly.Template.NetTiers.Data.Query
{
    internal class ExpressionParserBaseTemp : CodeGeneratorBase<QueryDirectory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.ExpressionParserBase);
        ...
        {
            string className = "ExpressionParserBase";
