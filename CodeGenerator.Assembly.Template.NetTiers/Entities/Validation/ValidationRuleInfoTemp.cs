...
{
    internal class ValidationRuleInfoTemp : CodeGeneratorBase<ValidationDirectory, DatabaseInfoModel>
    {
        private async Task<CompilationUnitSyntax> GetCompilationUnit(DatabaseInfoModel model, string className)
        {
            var tree = CSharpSyntaxTree.ParseText(StaticFileResource.ValidationRuleInfo);
        ...
        {
            string className = "ValidationRuleInfo";
